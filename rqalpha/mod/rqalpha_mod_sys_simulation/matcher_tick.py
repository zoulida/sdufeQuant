...
class Matcher_Tick(object):
    ...
    def _create_deal_price_decider(self, matching_type):
        decider_dict = {
            MATCHING_TYPE.TICK_CURRENT_BAR: self._current_bar_tick_price_decider,
    ...
    def _current_bar_tick_price_decider(self, order_book_id, _):
        try:
            tickbase = tickCache.MysqlCache()
            price = tickbase.getLastTickPriceByEnvironment(order_book_id)
            return price #zoulida
            #return self._env.bar_dict[order_book_id].price
